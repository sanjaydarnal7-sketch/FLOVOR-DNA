      ...
      <GlassmorphicCard className="w-full max-w-3xl max-h-[90vh] overflow-y-auto" onClick={handleModalContentClick}>
        <div className="relative">
          <form onSubmit={handleSubmit} className="p-6">
            <h2 className="text-2xl font-bold text-gray-100 mb-6 uppercase tracking-wider">{isEditing ? 'Edit Component DNA' : 'Add New Component'}</h2>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
              <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
                <input name="name" value={formData.name} onChange={handleInputChange} placeholder="Component Name" required className="w-full bg-slate-800 border border-slate-700 rounded-md px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-cyan-400" />
                <input name="category" value={formData.category} onChange={handleInputChange} placeholder="Category (e.g., AI Model)" className="w-full bg-slate-800 border border-slate-700 rounded-md px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-cyan-400" />
              </div>
              
              <div className="space-y-4">
                <h3 className="font-semibold text-cyan-300 uppercase tracking-wider">Core Metrics</h3>
              ...
              <div className="space-y-4">
                 <h3 className="font-semibold text-cyan-300 uppercase tracking-wider">Conceptual Biases</h3>
              ...
              <div className="md:col-span-2">
                <h3 className="font-semibold text-cyan-300 mb-2 uppercase tracking-wider">Descriptors</h3>
              ...
              <div className="md:col-span-2 space-y-4">
                  <textarea name="abstract" value={formData.abstract} onChange={handleInputChange} placeholder="Abstract / Core Idea..." rows={3} className="w-full bg-slate-800 border border-slate-700 rounded-md px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-cyan-400"></textarea>
                  <input name="sourceURL" value={formData.sourceURL} onChange={handleInputChange} placeholder="Source URL (e.g., arXiv, Wikipedia)" className="w-full bg-slate-800 border border-slate-700 rounded-md px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-cyan-400" />
              </div>
            </div>
